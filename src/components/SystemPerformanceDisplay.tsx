...
export function SystemPerformanceDisplay({ tracksCount, isPlaying }: SystemPerformanceDisplayProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1.5 kumbh-sans leading-none text-[8px]">
        {/* Labels Column */}
        <div className="flex flex-col gap-[1px] text-[#666] font-bold w-[18px] shrink-0 kumbh-sans">
          <div>CPU</div>
          <div>RAM</div>
        </div>
          ...
          <div className="space-y-2 text-[10px]">
            <div>
              <div className="flex justify-between text-[#aaa] mb-0.5">
                ...
                <span className="kumbh-sans text-[#00f0ff] font-bold">{cpu}%</span>
              </div>
            ...
            <div>
              <div className="flex justify-between text-[#aaa] mb-0.5">
                ...
                <span className="kumbh-sans text-[#ffd900] font-bold">{ramMB} MB ({ramPercent}%)</span>
              </div>
              <div className="w-full bg-[#111] h-1.5 rounded-full overflow-hidden border border-[#333]">
                <div 
