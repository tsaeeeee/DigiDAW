  ...
  return (
    <div className="fixed inset-0 z-[300] pointer-events-none">
      <div
        ref={modalRef}
        onMouseDown={() => onFocus?.()}
        style={{ left: `${position.x}px`, top: `${position.y}px`, width: '440px', zIndex: zIndex ?? 310 }}
        className="fixed pointer-events-auto bg-[#202023] border border-[#3e3e44] rounded-lg shadow-[0_20px_50px_rgba(0,0,0,0.95)] flex flex-col overflow-hidden font-sans select-none animate-in fade-in zoom-in-95 duration-100"
      >
        {/* Header Bar */}
        <div
